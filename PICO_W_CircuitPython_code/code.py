...
loop1 = 0
loopt1 = 100 # _________________________________________ we can read time every loop OR every loopt loop only, makes the 1M faster (26s to 31s)/ but timer more inaccurate
...
loop2 = 200
loopt2 = 1000 # ________________________________________ we can read time every loop OR every loopt loop only, makes the 1M faster (26s to 31s)/ but timer more inaccurate
...
loop5 = 500
loopt5 = 1000 # ________________________________________ we can read time every loop OR every loopt loop only, makes the 1M faster (26s to 31s)/ but timer more inaccurate
...
def JOBSYS() : # _________________________________________ in here call webserver updates...
    ...
    if False : # _______________________________________ for first test only used
        dp("#", end="")
    run_webserver() # __________________________________ update if someone called our page
